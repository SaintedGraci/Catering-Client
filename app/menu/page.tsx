  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-12">
        <Link href="/" className="text-amber-600 hover:text-amber-700 mb-6 inline-block">
          ← Back to Home
        </Link>
        ...
        <div className="mt-12 text-center">
          <Link 
            href="/contact" 
            className="bg-amber-600 text-white px-8 py-3 rounded-lg hover:bg-amber-700 transition inline-block"
          >
            Request Custom Menu
          </Link>
        </div>
